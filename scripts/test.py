...
from graspnet.dataset import GraspNetDataset, collate_fn
from graspnet.collision_detector import ModelFreeCollisionDetector

parser = argparse.ArgumentParser()
parser.add_argument("--dataset_root", default="/workspace/dataset/graspnet", help="Dataset root")
parser.add_argument("--checkpoint_path", default="checkpoint-rs.tar", help="Model checkpoint path")
parser.add_argument("--dump_dir", default="eval_results", help="Dump dir to save outputs")
parser.add_argument("--camera", default="realsense", help="Camera split [realsense/kinect]")
parser.add_argument("--num_point", type=int, default=20000, help="Point Number [default: 20000]")
parser.add_argument("--num_view", type=int, default=300, help="View Number [default: 300]")
parser.add_argument("--batch_size", type=int, default=1, help="Batch Size during inference [default: 1]")
parser.add_argument(
    "--collision_thresh", type=float, default=0.01, help="Collision Threshold in collision detection [default: 0.01]"
)
parser.add_argument(
    "--voxel_size",
    type=float,
